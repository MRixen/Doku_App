...
\hline 
\textbf{Serien-Nr.} & 123456 \\ 
\hline 
\textbf{Software-Version} & 123456 \\ 
\hline 
\textbf{Robotertyp} & IRB 140 \\ 
\hline 
\textbf{Steuerungs-ID} & xxx \\ 
\hline 
...
Das Zeichen X dient als Platzhalter für String-Parameter. Diese können aktuell 
nicht vollständig gesendet werden, da sonst der zu übertragende String zu viel 
Zeichen enthält (max. Länge 80 Zeichen). 
